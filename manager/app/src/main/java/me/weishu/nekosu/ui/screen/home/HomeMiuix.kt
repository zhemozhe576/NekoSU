package me.weishu.nekosu.ui.screen.home
...
import me.weishu.nekosu.KernelVersion
import me.weishu.nekosu.R
import me.weishu.nekosu.ui.component.dialog.rememberConfirmDialog
import me.weishu.nekosu.ui.component.miuix.WarningCard
...
import me.weishu.nekosu.ui.util.module.LatestVersionInfo
                            ...
                            if (state.currentManagerVersionCode < (state.ksuVersion ?: 0)) {
                                ...
                                WarningCard(
                                    stringResource(
                                        ...
                                        state.ksuVersion ?: 0,
                                        me.weishu.nekosu.Natives.MINIMAL_SUPPORTED_KERNEL
                                    )
                                )
                            }
                        }
        ...
        when {
            ...
            state.kernelVersion.isGKI() -> {
                Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                    NekoCard(
                        cardId = "home_status_not_installed",
