...
lateinit var ksuApp: NekoSUApplication

class NekoSUApplication : Application(), ViewModelStoreOwner {
                ...
                .addInterceptor { block ->
                    block.proceed(
                        block.request().newBuilder()
                            .header("User-Agent", "NekoSU/${BuildConfig.VERSION_CODE}")
