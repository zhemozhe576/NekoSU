...
import me.weishu.nekosu.ui.component.miuix.SendLogDialog
                ...
                item {
                    ...
                    Card(
                        ...
                        ArrowPreference(
                            title = "NekoSU 美化",
                            summary = when {
                                nekoConfig.globalBackground.isActive() && nekoConfig.uiLayout == "neko" -> "NekoUI · 已设置背景"
                                nekoConfig.globalBackground.isActive() -> "已设置背景"
                                nekoConfig.uiLayout == "neko" -> "NekoUI"
                                else -> null
                            },
                            startAction = {
                                Icon(
