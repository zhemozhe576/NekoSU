...
import me.weishu.nekosu.ui.viewmodel.ModuleRepoViewModel
...
fun ModuleRepoScreen() {
    ...
    when (LocalUiMode.current) {
        ...
        UiMode.Neko -> ModuleRepoScreenMiuix(uiState, actions)
    }
}
...
fun ModuleRepoDetailScreen(module: RepoModuleArg) {
    ...
    when (LocalUiMode.current) {
        ...
        UiMode.Neko -> ModuleRepoDetailScreenMiuix(state, actions)
    }
}
