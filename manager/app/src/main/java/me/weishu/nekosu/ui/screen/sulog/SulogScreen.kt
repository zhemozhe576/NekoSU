...
import me.weishu.nekosu.ui.util.SulogEventType
import me.weishu.nekosu.ui.util.SulogFile
import me.weishu.nekosu.ui.util.toSulogDisplayName
import me.weishu.nekosu.ui.viewmodel.SulogViewModel
...
fun SulogScreen() {
    ...
    when (uiMode) {
        ...
        UiMode.Neko -> SulogScreenMiuix(state, actions)
    }
}
