package me.weishu.nekosu.ui.screen.superuser
...
import me.weishu.nekosu.ui.component.AppIconImage
...
import me.weishu.nekosu.ui.util.ownerNameForUid
import me.weishu.nekosu.ui.util.rememberBlurBackdrop
import me.weishu.nekosu.ui.viewmodel.AppSortType
...
private fun SimpleAppItem(
    ...
    Row {
        ...
        NekoCard(
            cardId = "superuser_app_${app.packageName}",
            modifier = Modifier
...
private fun GroupItem(
    ...
    NekoCard(
        cardId = "superuser_group_${group.uid}",
        modifier = Modifier
