...
import me.weishu.nekosu.NekoSUApplication
...
fun ColorPaletteScreen() {
    ...
    val actions = ColorPaletteScreenActions(
        ...
        onSetEnablePredictiveBack = {
            ...
            NekoSUApplication.setEnableOnBackInvokedCallback(context.applicationInfo, it)
            activity?.recreate()
        },
    ...
    when (LocalUiMode.current) {
        ...
        UiMode.Neko -> ColorPaletteScreenMiuix(state, actions)
    }
}
