package me.weishu.nekosu.magica;

import static me.weishu.nekosu.magica.AppZygotePreload.TAG;
...
import me.weishu.nekosu.ui.util.KsuCliKt;
...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Intent.ACTION_LOCKED_BOOT_COMPLETED.equals(action)
                ...
                && !"me.weishu.nekosu.magica.LAUNCH".equals(action)) {
            return;
        }
