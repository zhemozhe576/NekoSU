...
val defaultManagerPackageName = if (isPrBuild) "me.weishu.nekosu.pr" else "me.weishu.nekosu"
val defaultManagerName = if (isPrBuild) "NekoSU PR" else "NekoSU"
